...
const AuthForm = ({ isLogin, onSubmit, error, success, loading }) => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen max-sm:bg-white bg-gray-100">
            <div className="w-full max-sm:p-4 max-w-md p-8 space-y-8 bg-white rounded-lg max-sm:shadow-none shadow-lg shadow-gray-200">
                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                    ...
                    <div>
                        <button
                            type="submit"
                            className="group relative flex w-full rounded-lg justify-center py-3 px-4 bg-gradient-to-r from-[#0074b4] to-[#00b34c] text-md font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                        >
